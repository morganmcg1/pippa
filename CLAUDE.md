...
7. [Absolute Zero Paper](https://arxiv.org/pdf/2505.03335v2) - Self-play for math reasoning

## Absolute Zero Experiment (2025-06-15)

### Overview
Implementation of Absolute Zero algorithm from https://arxiv.org/pdf/2505.03335v2 for arithmetic self-play learning.

### Key Components
1. **Proposer Model**: Generates arithmetic problems based on current solver capability
2. **Solver Model**: Solves generated problems (same base model as proposer)
3. **Learnability Rewards**: Proposer rewarded for problems that help solver improve
4. **TRR++ Algorithm**: Task-Relative REINFORCE++ with 6 separate baselines

### Location
- **Directory**: `absolute_zero/`
- **Research Journal**: `research_journal/absolute_zero.md`
- **Main Script**: `absolute_zero/train_absolute_zero_baseline.py`
- **Virtual Environment**: `absolute_zero/az_venv`
...
- **Self-Generated Curriculum**: Problems generated by proposer, not fixed dataset
- **Dual Training**: Both proposer and solver models trained simultaneously
- **Learnability Signal**: Proposer optimized to generate helpful problems
- **Natural Curriculum**: Difficulty emerges from proposer learning

### Configuration (Based on GRPO Success)
- Model: Qwen/Qwen2-0.5B-Instruct
- Temperature: 0.7 (solver), 1.0 (proposer for diversity)
- KL Penalty: beta=0.1
- Learning Rate: 5e-6
- Batch Size: 32 (reduced due to two models)
