#!/usr/bin/env python3
"""
GRPO Arithmetic Training - Mixed Dataset with FULL Diversity
Combines arithmetic with simpler tasks AND maintains proper generation diversity
...
def main():
    ...
    # Training configuration - FULL DIVERSITY
    n_samples = 150
    batch_size = 240  # Adjusted for 16 generations (240 ÷ 16 = 15)
    ...
    wandb.init(
        ...
        name="grpo_arithmetic_mixed_dataset_full_diversity",
        tags=["grpo-setup", "arithmetic", "overfit", "break-barrier", "mixed-tasks", "full-diversity"],
        config={
            "model": model_name,
            "n_samples": n_samples,
            ...
            "seed": SEED,
            "beta": 0.1,
            "experiment": "mixed_dataset_full_diversity",
    ...
    print(f"\n{'='*60}")
    print("MIXED DATASET WITH FULL DIVERSITY")
    print(f"{'='*60}")
    ...
    config = GRPOConfig(
        output_dir="./grpo-arithmetic-mixed-full-div",
    ...
    print("\nStarting training with mixed dataset and FULL diversity...")
    print("Hypothesis: Easier tasks + proper generation diversity = better learning")
    trainer.train()
