#!/usr/bin/env python3
"""
GRPO training with rich rewards + temperature exploration.
Testing different temperatures to see if we can improve on 75%.
"""
...
def main():
    ...
    wandb.init(
        ...
        name="grpo_rich_temperature_0.5",
        tags=["grpo-setup", "standardized-eval", "rich-rewards", "temperature-exploration"],
        config={
            "model": model_name,
            "n_samples": n_samples,
    ...
    # GRPO configuration
    config = GRPOConfig(
        output_dir="./grpo-rich-temp-0.5",
        run_name="grpo_rich_temperature_0.5",
        ...
        num_generations=num_generations,
        temperature=temperature,  # Lower temperature
    ...
    print("\n" + "="*60)
    print("RICH REWARDS + TEMPERATURE 0.5 EXPERIMENT")
    print("="*60)
    print("Testing lower temperature (0.5) for more focused generation")
    print("Hypothesis: Less randomness might improve accuracy")
    print("Previous best: 75% with temperature 0.7")
    print("="*60 + "\n")
    ...
    print("Starting training with rich rewards + temperature 0.5...")
    trainer.train()
    ...
    print(f"\n" + "="*60)
    print("FINAL RESULTS - Rich Rewards + Temperature 0.5")
    print("="*60)
    print(f"Final standardized eval accuracy: {final_eval_metrics['eval_accuracy']:.2%}")
    print(f"Previous rich rewards best (temp 0.7): 75.0%")
    print("="*60)
