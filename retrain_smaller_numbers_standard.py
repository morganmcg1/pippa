#!/usr/bin/env python3
"""
Retrain Smaller Numbers Full Diversity model with standardized evaluation.
Based on run ipnl8nmm which achieved 45% (on 0-10 test set).
...
def main():
    ...
    # Training configuration - matching successful ipnl8nmm
    n_samples = 130
    batch_size = 256  
    num_generations = 16  # Full diversity
    learning_rate = 5e-6
    temperature = 0.7
    ...
    wandb.init(
        ...
        name="retrain_smaller_numbers_standard",
        tags=["grpo-setup", "standardized-eval", "arithmetic", "small-numbers", "retrain"],
        config={
            "model": model_name,
            "n_samples": n_samples,
            ...
            "number_range": "0-10",
            "based_on_run": "ipnl8nmm"
        }
    )
    
    print("Creating smaller numbers dataset...")
    ...
    # GRPO configuration
    config = GRPOConfig(
        output_dir="./grpo-smaller-numbers-standard",
        run_name="retrain_smaller_numbers_standard",
