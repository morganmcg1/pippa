#!/usr/bin/env python3
"""
GRPO training with rich reward function that provides partial credit.
Instead of binary +1/-1, we give graduated rewards based on how close the answer is.
"""
...
def main():
    ...
    wandb.init(
        ...
        name="grpo_rich_rewards",
        tags=["grpo-setup", "standardized-eval", "rich-rewards", "partial-credit"],
        config={
            "model": model_name,
            "n_samples": n_samples,
    ...
    # GRPO configuration
    config = GRPOConfig(
        output_dir="./grpo-rich-rewards",
        run_name="grpo_rich_rewards",
    ...
    print("\n" + "="*60)
    print("RICH REWARD EXPERIMENT")
    print("="*60)
    print("Reward scheme:")
    print("- Correct: +1.0")
    print("- Off by 1: +0.7")
    print("- Off by 2: +0.4")
    print("- Off by 3-5: +0.1")
    print("- Off by 6-10: -0.2")
    print("- Off by >10: -0.5")
    ...
    print("Starting training with rich rewards...")
    trainer.train()
    ...
    print(f"\n" + "="*60)
    print("FINAL RESULTS - Rich Rewards")
    print("="*60)
    print(f"Final standardized eval accuracy: {final_eval_metrics['eval_accuracy']:.2%}")
    print(f"Binary reward best: 45.5%")
    print(f"Base model baseline: ~38%")
    print(f"Improvement over binary: {final_eval_metrics['eval_accuracy'] - 0.455:.2%}")
    print("="*60)
